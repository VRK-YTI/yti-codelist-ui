...
export class ExtensionSchemeExtensionsComponent {
  ...
  getIdIdentifier(extension: Extension) {
    return `${this.extensionScheme.parentCodeScheme.codeRegistry.codeValue}_${this.extensionScheme.parentCodeScheme.codeValue}_${this.extensionScheme.codeValue}_${extension.id}`;
  }
}
