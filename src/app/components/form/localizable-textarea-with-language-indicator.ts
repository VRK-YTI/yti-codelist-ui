...
@Component({
  selector: 'app-localizable-textarea-with-language-indicator',
  template: `
    <dl *ngIf="show">
      <dt>
        <label>{{label}}</label>
...
export class LocalizableTextareaWithLanguageIndicatorComponent implements ControlValueAccessor {
